...
Route::middleware('auth.jwt')->prefix('playing-schedules')->group(function () {
    ...
    Route::post('/reorder', [PlayingScheduleController::class, 'reorder'])->middleware('perm.club:playing_schedule,update');
