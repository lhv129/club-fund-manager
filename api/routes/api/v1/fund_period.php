...
Route::middleware('auth.jwt')->prefix('fund-periods')->group(function () {
    ...
    Route::post('/reorder', [FundPeriodController::class, 'reorder'])->middleware('perm.club:fund_period,update');
