...
Route::middleware('auth.jwt')->prefix('exchange-sessions')->group(function () {
    ...
    Route::post('/reorder', [ExchangeSessionController::class, 'reorder'])->middleware('perm.club:exchange_session,update');
