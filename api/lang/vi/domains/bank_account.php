...
/**
 * EXAMPLE DOMAIN LANGUAGE FILE
 * ------------------------------------------
 * Tất cả message liên quan Example module
 */
...
return [
    ...
    'detail'         => 'Lấy chi tiết tài khoản ngân hàng thành công.',
    'select'         => 'Lấy danh sách tài khoản ngân hàng (dropdown) thành công.',
