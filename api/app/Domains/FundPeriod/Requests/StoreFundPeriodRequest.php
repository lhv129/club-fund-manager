...
class StoreFundPeriodRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'male_amount'       => ['required', 'numeric', 'min:0'],
            'female_amount'     => ['required', 'numeric', 'min:0'],
            'exchange_male_amount'   => ['required', 'numeric', 'min:0'],
            'exchange_female_amount'   => ['required', 'numeric', 'min:0'],
