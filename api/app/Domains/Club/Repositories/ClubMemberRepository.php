...
class ClubMemberRepository extends BaseRepository
{
    ...
    public function getClubAdministrators(int $clubId): EloquentCollection
    {
        return $this->model
            ->select('id','club_id','user_id','join_type','status','is_active')
            ->where('club_id', $clubId)
            ->active()
            ->whereHas('clubMemberRoles', function ($query) use ($clubId) {
                $query
                    ->where('club_id', $clubId)
    ...
    public function getActiveUserIds(int $clubId): SupportCollection
    {
        return $this->model
            ->where('club_id', $clubId)
            ->active()
