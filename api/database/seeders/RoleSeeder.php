    ...
    private array $roles = [
        ...
        [
            ...
            'permissions' => [
                ...
                'club_member'         => ['view', 'create', 'update', 'delete'],
                'fund_period'         => ['view', 'create', 'update', 'delete'],
                'transaction'         => ['view', 'create', 'update', 'delete'],
                'exchange_session'    => ['view', 'create', 'update', 'delete'],
                'playing_schedule'   => ['view', 'create', 'update', 'delete'],
                'member_payment_code' => ['view', 'update'],
        ...
        [
            ...
            'permissions' => [
                'club'                => ['view'],
                'club_member'         => ['view', 'create', 'update', 'delete'],
                'fund_period'         => ['view', 'create', 'update'],
                'transaction'         => ['view', 'create', 'update'],
                'exchange_session'    => ['view', 'create', 'update', 'delete'],
                'playing_schedule'   => ['view', 'create', 'update'],
                'member_payment_code' => ['view', 'update'],
                'webhook'             => ['view'],
            ],
        ],
