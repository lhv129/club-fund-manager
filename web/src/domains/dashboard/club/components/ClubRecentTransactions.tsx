...
export function ClubRecentTransactions({
  data,
  slug,
  locale,
}: {
        ...
        <div className="divide-y divide-border px-4 sm:px-5">
          {data.map((transaction) => {
            ...
            return (
              ...
              >
                <span
                  className={`flex size-9 shrink-0 items-center justify-center rounded-xl ${income
                ...
                <span
                  className={`whitespace-nowrap text-sm font-semibold ${income
                      ? "text-emerald-500"
                      : "text-red-500"
                    }`}
                >
